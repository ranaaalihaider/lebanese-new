    ...
    <div class="p-6">
        <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="{{ route('seller.products.index') }}" class="text-gray-500 hover:text-gray-700">&times; Cancel</a>
            </div>
            ...
            <form action="{{ route('seller.products.update', $product) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2">Category / Type</label>
                ...
                <div class="mb-6">
                    ...
                    <p class="text-xs text-gray-500 mt-1">Upload new photos to add to existing ones.</p>
                </div>

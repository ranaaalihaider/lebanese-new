        ...
        <div
            ...
            <div>
                ...
                <div class="flex gap-4 text-sm text-stone-500">
                    ...
                    <p>•</p>
                    <p>@trans('Buyer:') <span class="font-bold text-stone-700">{{ $order->buyer->name }}</span>
                        ({{ $order->buyer->phone }})</p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-2">
                @if($order->status === 'pending')
                    ...
                    <form action="{{ route('seller.orders.update-status', $order) }}" method="POST">
                        ...
                        <button type="submit"
                            class="text-red-600 hover:text-red-900 bg-red-50 px-4 py-2 rounded-lg border border-red-200 hover:bg-red-100 font-bold transition-colors">@trans('Reject')</button>
                    </form>
                @endif
                ...
                <div>
                    ...
                    <div class="bg-emerald-50 p-4 rounded-xl shadow-sm border border-emerald-100">
                        ...
                        <div class="mt-3 pt-3 border-t border-emerald-200/50">
                            <p class="text-sm text-stone-600">@trans('Store Phone:') <a href="tel:{{ $order->seller->phone }}"
                ...
                <div>
                    ...
                    <div class="bg-white p-4 rounded-xl shadow-sm border border-stone-200">
                        ...
                        <div class="mt-3 pt-3 border-t border-stone-100">
                            <p class="text-sm text-stone-500">@trans('Buyer Phone:') <a href="tel:{{ $order->buyer->phone }}"
            ...
            <div>
                ...
                <div class="bg-white p-4 rounded-xl shadow-xs border border-stone-200 space-y-2">
                    ...
                    <div class="border-t border-stone-100 pt-2 flex justify-between text-sm">
                        <span class="font-bold text-emerald-700">@trans('Your Net Earning')</span>
                        <span

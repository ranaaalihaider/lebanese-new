        ...
        <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-6">
            ...
            <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6 pb-6 border-b border-stone-200">
                    <label class="block text-stone-700 text-sm font-bold mb-3">Site Logo</label>
                    ...
                    @if($logoPath)
                        <div class="mb-4">
                            ...
                            <p class="text-xs text-stone-500 mt-2">Current Logo</p>
                        </div>
                    @endif
                ...
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2">Business / Site Name</label>
                ...
                <div class="mb-6 pb-6 border-t border-stone-200 pt-6">
                    <label class="block text-stone-700 text-sm font-bold mb-4">Global Payment Methods</label>
                    <div class="space-y-3">
                    ...
                    <p class="text-xs text-stone-500 mt-2">Selected methods will be available to all buyers at checkout.</p>
                </div>

    ...
    <div class="min-h-screen bg-gradient-to-br from-stone-50 to-stone-100 pb-20 md:pb-6">
        ...
        <div class="bg-white border-b border-stone-200 px-4 md:px-6 py-6 md:py-8">
            <div class="max-w-7xl mx-auto">
                <h1 class="text-2xl md:text-3xl font-bold text-stone-900">Platform Revenue</h1>
                <p class="text-stone-600 text-sm md:text-base mt-1">Track earnings and transaction history</p>
            </div>
        </div>
                    ...
                    <form method="GET" action="{{ route('admin.earnings') }}" class="space-y-4">
                        ...
                        <div>
                            <label class="block text-xs font-bold text-stone-700 mb-2">
                                ...
                                Search by Store, Order #, or Product
                            </label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <!-- Store Filter -->
                            <div>
                                <label class="block text-xs font-bold text-stone-700 mb-2">Filter by Store</label>
                            ...
                            <!-- Date From -->
                            <div>
                                <label class="block text-xs font-bold text-stone-700 mb-2">From Date</label>
                            ...
                            <!-- Date To -->
                            <div>
                                <label class="block text-xs font-bold text-stone-700 mb-2">To Date</label>
            ...
            document.getElementById('revenue-filter-container').classList.toggle('hidden');
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-6">
                    <div
                        ...
                        <p class="text-xs font-bold text-stone-600 uppercase">Total Orders</p>
                    ...
                    <div
                        ...
                        <p class="text-xs font-bold text-emerald-600 uppercase">Net Revenue</p>
                    ...
                    <div
                        ...
                        <p class="text-xs font-bold text-blue-600 uppercase">Seller Earnings</p>
                        ...
                        @foreach($orders as $order)
                            <div class="bg-white rounded-2xl border border-stone-200 shadow-sm overflow-hidden">
                                ...
                                <div class="p-4 space-y-3">
                                    <!-- Product -->
                                    <div>
                                        <p class="text-xs text-stone-500 uppercase font-bold mb-1">Product</p>
                                    ...
                                    <div class="bg-stone-50 rounded-xl p-3 space-y-2">
                                        ...
                                        <div class="flex justify-between text-sm">
                                            <span class="text-stone-600">Seller Cut</span>
                ...
                @else
                    <div class="text-center py-16 bg-white rounded-2xl border border-dashed border-stone-200">
                        ...
                        <h3 class="text-lg font-medium text-stone-900">No revenue data found</h3>
                        <p class="text-stone-500 mt-1">Try adjusting your filters or wait for sellers to complete orders.</p>
                    </div>
                @endif
            </div>
        </div>

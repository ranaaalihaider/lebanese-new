...
<div class="min-h-screen bg-stone-50 pb-20 md:pb-6">
    ...
    <div class="bg-gradient-to-r from-emerald-600 to-emerald-700 md:bg-white md:border-b md:border-stone-200">
        <div class="max-w-7xl mx-auto px-4 py-4 md:py-6">
            ...
            <div class="md:hidden">
                <h1 class="text-xl font-bold text-white">@trans('Buyers')</h1>
                <p class="text-emerald-100 text-sm mt-0.5">{{ $buyers->total() }} customers</p>
            </div>
            
            <!-- Desktop Header -->
            <div class="hidden md:block">
                <h1 class="text-2xl md:text-3xl font-bold text-white">@trans('Buyer Management')</h1>
                <p class="text-emerald-50 text-sm md:text-base mt-1">@trans('Manage customer accounts and track activity')</p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-0 md:px-6 py-0 md:py-8">
        ...
        <div class="bg-white md:rounded-2xl md:shadow-sm md:border md:border-stone-200 p-3 md:p-6 mb-3 md:mb-6">
            <div class="flex items-center justify-between mb-4">
                <h2 class="hidden md:block text-lg font-bold text-stone-900">@trans('Search')</h2>
        ...
        <div class="md:hidden flex gap-2 px-4 pb-3 overflow-x-auto scrollbar-hide">
            ...
            <div class="bg-white rounded-2xl px-4 py-2 flex-shrink-0 shadow-sm">
                <p class="text-xs text-stone-500">@trans('Active')</p>
                <p class="text-lg font-bold text-emerald-600">{{ $activeBuyers }}</p>
            </div>
            <div class="bg-white rounded-2xl px-4 py-2 flex-shrink-0 shadow-sm">
                <p class="text-xs text-stone-500">@trans('Results')</p>
        ...
        <div class="hidden md:grid grid-cols-3 gap-4 mb-6">
            ...
            <div class="bg-purple-50 rounded-xl border border-purple-200 p-4">
                <p class="text-xs text-purple-600 uppercase font-bold">@trans('Results')</p>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-stone-200">
                        <thead class="bg-stone-50">
                            <tr>
                                <th class="px-6 py-4 text-left text-xs font-bold text-stone-500 uppercase tracking-wider">@trans('Buyer')</th>
                                <th class="px-6 py-4 text-left text-xs font-bold text-stone-500 uppercase tracking-wider">@trans('Contact')</th>
                                <th class="px-6 py-4 text-center text-xs font-bold text-stone-500 uppercase tracking-wider">@trans('Orders')</th>
                                <th class="px-6 py-4 text-right text-xs font-bold text-stone-500 uppercase tracking-wider">@trans('Total Spent')</th>
                                <th class="px-6 py-4 text-right text-xs font-bold text-stone-500 uppercase tracking-wider">@trans('Actions')</th>
                            </tr>
                        </thead>

            ...
            <div class="bg-white rounded-2xl shadow-sm border border-stone-100 overflow-hidden">
                <div class="p-8">
                    <div class="flex items-center gap-6 mb-8 border-b border-stone-100 pb-8">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold text-stone-900">Edit Your Review</h1>
                    ...
                    <form action="{{ route('buyer.reviews.update', $review) }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div>
                            <label class="block text-sm font-medium text-stone-700 mb-2">Update Photo</label>
                            ...
                            <div class="flex items-center gap-4">
                                <div
                                    ...
                                    <div id="upload-placeholder"
                                        ...
                                        <span class="text-xs text-stone-500 block mt-1">Change</span>
                                    </div>
                                ...
                                <div class="text-sm text-stone-500">
                                    <p class="font-medium text-stone-700">Tap to change image</p>

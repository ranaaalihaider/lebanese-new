    ...
    <div class="max-w-3xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="md:col-span-1 md:order-2">
                <div class="bg-white rounded-2xl shadow-sm border border-stone-100 p-6 sticky top-24">
                    ...
                    <div class="flex gap-3 mb-4">
                        ...
                        <div>
                            <h3 class="text-sm font-bold text-stone-900 line-clamp-2">{{ $product->name }}</h3>
                            <p class="text-xs text-stone-500">{{ $product->seller->sellerProfile->store_name }}</p>
                        </div>
                    </div>
            ...
            <div class="md:col-span-2 md:order-1">
                <form action="{{ route('buyer.checkout.store', $product) }}" method="POST">
                    @csrf
